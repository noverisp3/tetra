...
\author{Ph\d{a}m Ph\'u Nguy\^en \\[0.3em]Thang Long High School, Vietnam \\
\texttt{nguyenpham2044@gmail.com}
}

\iclrfinalcopy % Camera-ready: shows author names. Comment out for anonymous submission.
\begin{document}
