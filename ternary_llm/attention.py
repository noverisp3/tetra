...
class StochasticMultiHeadAttention(nn.Module):
    ...
    def __init__(self, hidden_dim, num_heads, dropout=0.0, scale=1.0, threshold=None, int8=False, per_channel=False, group_size=0, outlier_thr_mult=3.0):
        super().__init__()
        ...
        self.q_proj = StochasticTernaryLinear(hidden_dim, hidden_dim, scale=scale, threshold=threshold, int8=int8, per_channel=per_channel, group_size=group_size, outlier_thr_mult=outlier_thr_mult)
        self.k_proj = StochasticTernaryLinear(hidden_dim, hidden_dim, scale=scale, threshold=threshold, int8=int8, per_channel=per_channel, group_size=group_size, outlier_thr_mult=outlier_thr_mult)
        self.v_proj = StochasticTernaryLinear(hidden_dim, hidden_dim, scale=scale, threshold=threshold, int8=int8, per_channel=per_channel, group_size=group_size, outlier_thr_mult=outlier_thr_mult)
        self.o_proj = StochasticTernaryLinear(hidden_dim, hidden_dim, scale=scale, threshold=threshold, int8=int8, per_channel=per_channel, group_size=group_size, outlier_thr_mult=outlier_thr_mult)
        self.attn_dropout = nn.Dropout(dropout)
